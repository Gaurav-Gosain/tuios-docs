...
description: A flaky TUI fuzz suite came down to a PTY line discipline I never configured, and a shrinker that minimised straight toward the race.
date: '2026-07-07'
...
[end-to-end suite](/docs/contributing#other-test-suites) runs on it. Once that
...
and that got [its own post](/blog/the-fuzzer-that-found-nothing).)
