...
description: A profile put 19.8% of the tuios client in lipgloss.Wrap, rewrapping pane text already the right width. Skipping it was easy. Proving the skip safe was the work.
date: '2026-08-22'
...
Compose time matters past its own frame, too. The same day, the time the
renderer spent holding a pane's lock turned out to be what made a flooded
pane [fall behind and keep painting](/blog/drawing-the-backlog). The
[architecture page](/docs/architecture#performance) has the rest of how the
