---
title: The screenshot cell was half measured and half guessed
description: Pane screenshots came out stretched. Two rounds of font maths got the cell shape wrong. The fix asks the host terminal for its real cell size in pixels.
date: '2026-08-27'
author: Gaurav Gosain
---

tuios can [save a capture of a pane](/docs/screenshots) as a PNG: the daemon hands over the
...
The next round of reports came from the [preview panel](/docs/screenshots#in-the-app), and this time I
...
graphics](/blog/a-terminal-that-lied-about-what-it-could-do). So the
