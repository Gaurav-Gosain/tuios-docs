...
description: One resize report turned out to be three separate defects, a wrong theory, and one behaviour that was correct all along. The benchmarks saw none of it. A log of which windows moved saw all of it in a single drag.
date: '2026-07-16'
...
found the second defect: with shared borders on, `SyncBSPTreeFromGeometry`
