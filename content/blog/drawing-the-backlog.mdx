...
description: A pane kept painting for 1.2 seconds after the program flooding it had exited. The flood alone did not cause it. The client's own renderer was eating the time it needed to catch up.
date: '2026-08-26'
