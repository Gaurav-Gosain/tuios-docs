---
title: 'The bug I closed three times: a speckled sprite in a WebGL terminal'
description: A speckled sprite in the tuios browser terminal. Three wrong closures, a test suite blind by construction, and a browser that salted its own pixel readback.
date: '2026-07-19'
author: Gaurav Gosain
---

The report was visual and specific: half-block sprites in the [browser terminal](/docs/web)
...
post is mostly about the three failures.
...
The second time, I did look at the data, and I did it properly. I rendered
...
The failure was in what "match" meant. I asked "does the speckle pattern I
...
defensible, which made it the most dangerous. I walked away sure.
...
report was a paragraph of explanation and a [renderer
toggle](/docs/web#browser-settings), both available from day one.
...
The first conclusion failed because I never looked. I assumed the category
...
the two I had defended in writing.
