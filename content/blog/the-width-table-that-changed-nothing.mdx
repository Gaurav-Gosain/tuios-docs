---
title: I ported a correct emoji width table and it fixed nothing
description: Emoji widths were wrong in the tuios browser client. I ported ghostty's per-codepoint width table and nothing changed, because width belongs to clusters.
date: '2026-06-27'
author: Gaurav Gosain
---

Emoji were breaking layout in the [browser terminal](/docs/web). A family emoji would claim
