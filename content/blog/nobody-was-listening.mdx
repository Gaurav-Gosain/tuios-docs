---
title: Three terminal bugs in one month turned out to be one bug
description: 'Terminals answer queries like OSC 11 and CPR. Three bugs in three codebases were one bug: the reply was dropped, sent to the wrong place, or echoed.'
date: '2026-06-19'
...
[a later post](/blog/fuzzing-a-terminal-test-harness).) Not a
...
[answered a capability query without asking](/blog/a-terminal-that-lied-about-what-it-could-do).
