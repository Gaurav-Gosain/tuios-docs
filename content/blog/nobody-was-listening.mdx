...
description: A terminal is a request-response protocol that most people write as if it were one-way. I hit the same bug three times in a month, in three different codebases, and each time the reply went somewhere different.
date: '2026-06-19'
