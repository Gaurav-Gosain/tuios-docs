...
then finished and not yet seen, then working. If you run four agents in four
worktrees, that list is supposed to answer one question without you looking at
any of them. Which one is waiting for me?

That question turned out to be much harder than drawing the list. This post is
about the week it took to answer it, and mostly about the one case every
