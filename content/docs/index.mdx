...
- **Command Palette** - Quick access to all commands with <kbd>Ctrl</kbd>+<kbd>P</kbd>, searching commands, keybindings, sessions, and windows, and launching any executable on `$PATH`
...
- **In-App Settings** - A settings page with live-applied, persisted options
