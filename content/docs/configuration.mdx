---
title: Configuration
description: Every table and option in config.toml, with defaults and how changes apply
icon: Settings
---
...
The daemon follows the file too, for `[hosts]` and `preferred_shell`. Adding or removing a host opens or closes its link at once.
