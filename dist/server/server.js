...
async function getStartManifest() {
  const { tsrStartManifest } = await import('./assets/_tanstack-start-manifest_v-D2QBF8u4.js');
...
const manifest = {'3dffc64eabe29fc8f5f4021f5e1cdf4bfea9319ffba3a59848ead9dcd2fa0308': {
                  functionName: 'loader_createServerFn_handler',
                  importer: () => import('./assets/_-IapnrOnj.js')
                }};
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import('./assets/router-yBWKifsJ.js').then(n => n.b);
    }
    if (startEntry === null) {
      startEntry = await import('./assets/start-Ch0oDu9F.js');
    }
    return {
      startEntry,
      routerEntry
...
export { TSS_SERVER_FUNCTION as T, createServerRpc as a, createServerFn as c, createServerEntry, server as default, getServerFnById as g };
